...
@else		
	...
	@if ($category_name!="All")
		<a class="dropdown-item" href="{{ action('\App\Http\Controllers\TicketsController@index') }}/filter/category/remove">{{ trans('panichd::lang.filter-category-all') }}</a>
	@endif
	{!! $text_cat !!}</ul>
	</div>
@endif
...
@if (session()->has('panichd_filter_owner'))
	...
	<ul class="dropdown-menu">
	<a class="dropdown-item" href="{{ action('\App\Http\Controllers\TicketsController@index') }}/filter/owner/remove">{{ trans('panichd::lang.filter-owner-all') }}</a>
	</ul>
	</div>
