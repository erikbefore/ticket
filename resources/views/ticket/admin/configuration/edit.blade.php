...
@section('footer')
    ...
    @if($should_serialize)
        <script src="{{asset('vendor/panichd/js/codemirror/mode/clike-' . App\Helpers\Cdn::CodeMirror . '.min.js')}}"></script>
        <script src="{{asset('vendor/panichd/js/codemirror/mode/php-' . App\Helpers\Cdn::CodeMirror . '.min.js')}}"></script>
