...
ENDHTML
    ...
    , 'summernote_locale' => <<<"ENDHTML"
			<p>
				...
				If value is <code>laravel</code>, locale set in nav-new-tickets-title<code>config/app.php</code> will be used
			</p>
