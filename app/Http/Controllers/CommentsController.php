...
class CommentsController extends Controller
{
    ...
    {
        $this->middleware('App\Http\Middleware\UserAccessMiddleware', ['only' => ['store']]);
		$this->middleware('App\Http\Middleware\AgentAccessMiddleware', ['only' => ['update', 'destroy']]);
    }
	...
	*/
    ...
    public function store(Request $request)
    {
		...
		DB::commit();
		event(new CommentCreated(Comment::find($comment->id), $request));
