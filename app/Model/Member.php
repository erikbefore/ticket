...
//	}
    ...
    {
        return $this->belongsTo('App\Model\Department', 'ticketit_department', 'id');
    }
	...
	*/
    ...
    {
        if ($complete) {
            return $this->hasMany('App\Model\Ticket', 'agent_id')->whereNotNull('completed_at');
        } else {
            return $this->hasMany('App\Model\Ticket', 'agent_id')->whereNull('completed_at');
        }
    }
    ...
    {
        if ($complete) {
            return $this->hasMany('App\Model\Ticket', 'user_id')->whereNotNull('completed_at');
        } else {
            return $this->hasMany('App\Model\Ticket', 'user_id')->whereNull('completed_at');
        }
    }
    ...
    {
        return $this->hasMany('App\Model\Ticket', 'agent_id');
    }
