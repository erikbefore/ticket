...
{
    public $email_domain = '@demonstracao.com'; // the email domain name for demo accounts. Ex. user1@example.com
    public $agents_qty = 2; // number of demo agents accounts
    ...
    public $default_user_password = 'bticket'; // default demo users accounts paasword
